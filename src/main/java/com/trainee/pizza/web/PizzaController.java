...
import com.trainee.pizza.domain.*;
...
//                              @RequestParam(value = "pizzaType" , required = true) PizzaType pizzaType)
    public String addNewPizza(Model model,
        ...
        BigDecimal bigDecimal = BigDecimal.valueOf(Float.parseFloat(price)).setScale(2,BigDecimal.ROUND_FLOOR);
        bigDecimal = bigDecimal.multiply(BigDecimal.valueOf(100));
        System.out.println("BigDecimal pizzas price: " + bigDecimal);
        //newPizza.setPrice(bigDecimal);
